...
if __name__ == '__main__':
    ...
    if submit_button:
        ...
        tab1.caption(recommendation['desc_2'].iloc[0])
        tab1.subheader('Description')
        tab1.caption(recommendation['desc_1'].iloc[0])
        tab1.subheader('Conclusion')
        tab1.caption(recommendation['desc_3'].iloc[0])
        ...
        tab2.caption(recommendation['desc_2'].iloc[1])
        tab2.subheader('Description')
        tab2.caption(recommendation['desc_1'].iloc[1])
        tab2.subheader('Conclusion')
        tab2.caption(recommendation['desc_3'].iloc[1])
        ...
        tab3.caption(recommendation['desc_2'].iloc[2])
        tab3.subheader('Description')
        tab3.caption(recommendation['desc_1'].iloc[2])
        tab3.subheader('Conclusion')
        tab3.caption(recommendation['desc_3'].iloc[2])
